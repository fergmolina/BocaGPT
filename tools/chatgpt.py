...
def get_message_from_openai(next_match_days = 0, matches = [], players = []):
    ...
    if next_match_days > 1:
        spell = """Crea un tweet donde se proporcine informacion detallada sobre el entrenamiento del dia de hoy, explicando algun tipo de ejercicio. 
                Agrega algun emoji relacionados con futbol o azul y amarillo. Hoy no es dia de partido ya que es """ + str(today) + """\n""" + str(matches)
    if next_match_days == 1:
        spell = """Crea un tweet dando informacion, como el oponente, el horario y el estadio sobre el proximo partido de Boca Jrs que es mañana ya que hoy es """ + str(today) + """. 
                Agrega algun emoji relacionados con futbol o azul y amarillo UNICAMENTE y ningun otro color. \n""" + str(matches)
        ...
        spell = """Crea un tweet armando el equipo titular usando UNICAMENTE los jugadores listados. 
                ...
                Agrega algun emoji relacionados con futbol o azul y amarillo.
